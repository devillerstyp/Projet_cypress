context('Choose the options to get credit with maried profil', () => {
    let profile = require('../../fixtures/mariedJdd.json')
    before(() => {
  ...
  it("Fill partner's professional situation",()=>{
    ...
    cy.profesionalPartenerActivity(profile.parteneractivityStep, profile.activityStatus) 
